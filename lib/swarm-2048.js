...
angular.module('swarm-2048').run(function($templateCache) {
  $templateCache.put('login',
    '<div class="login"><div class="title">Swarm 2048</div><div class="content"><div class="username"><div class="label">Please enter your name:</div><input ng-model="username"/></div><div ng-click="submit()" class="button">Start</div></div></div>'
  );
});
